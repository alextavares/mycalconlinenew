...
type CalculationMode = 'force' | 'displacement' | 'springConstant' | 'energy';

export default function HookesLawClientPage() {
  const t = useTranslations('HookesLawCalculator');
        ...
        <div className="bg-white rounded-xl shadow-md p-6 md:p-8 mb-8">
          ...
          {result !== null && (
            <div className={`mt-6 p-6 rounded-lg border-2 ${
              ...
              mode === 'displacement' ? 'bg-gradient-to-r from-green-50 to-emerald-50 border-green-200' :
